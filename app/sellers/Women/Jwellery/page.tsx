...
export default function Jwellery() {
  ...
  const [jwelleryProducts, setJwelleryProducts] = useState<any[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setJwelleryProducts(productsWithDate);
  ...
  const sortedJwelleryProducts = useMemo(() => {
    let productsCopy = [...jwelleryProducts];
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={mainFlexWrapperStyles}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: {currentUsername}'s Jwellery ({sortedJwelleryProducts.length})</h2>

          {isLoadingProducts && <p style={{ color: 'gray', padding: '0 20px' }}>Loading products...</p>}

          {!isLoadingProducts && sortedJwelleryProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No Jwellery products found for this seller.</p>
          )}

          <div style={styles.productGrid}>
            {sortedJwelleryProducts.map((product, i) => (
              <div
                key={product.key || i}
                style={{
