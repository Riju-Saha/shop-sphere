...
export default function Footwears() {
  ...
  const [footwearsProducts, setFootwearsProducts] = useState<any[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setFootwearsProducts(productsWithDate);
  ...
  const sortedFootwearsProducts = useMemo(() => {
    let productsCopy = [...footwearsProducts];
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={mainFlexWrapperStyles}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: {currentUsername}'s Footwears ({sortedFootwearsProducts.length})</h2>

          {isLoadingProducts && <p style={{ color: 'gray', padding: '0 20px' }}>Loading products...</p>}

          {!isLoadingProducts && sortedFootwearsProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No Footwears products found for this seller.</p>
          )}

          <div style={styles.productGrid}>
            {sortedFootwearsProducts.map((product, i) => (
              <div
                key={product.key || i}
                style={{
