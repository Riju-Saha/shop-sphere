...
export default function ChildrensClothing() {
  ...
  useEffect(() => {
    const category = 'Kids';
    const subCategory = 'ChildrensClothing';
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Stationary's ChildrensClothing ({sortedChildrensClothingProducts.length})</h2>
