...
export default function Headphones() {
  ...
  const [headphonesProducts, setHeadphonesProducts] = useState<any[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setHeadphonesProducts(productsWithDate);
  ...
  const sortedHeadphonesProducts = useMemo(() => {
    let productsCopy = [...headphonesProducts];
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={mainFlexWrapperStyles}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: {currentUsername}'s Headphones ({sortedHeadphonesProducts.length})</h2>

          {isLoadingProducts && <p style={{ color: 'gray', padding: '0 20px' }}>Loading products...</p>}

          {!isLoadingProducts && sortedHeadphonesProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No Headphones products found for this seller.</p>
          )}

          <div style={styles.productGrid}>
            {sortedHeadphonesProducts.map((product, i) => (
              <div
                key={product.key || i}
                style={{
