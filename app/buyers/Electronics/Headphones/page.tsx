...
export default function Headphones() {
  ...
  const [HeadphonesProducts, setHeadphonesProducts] = useState<Product[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setHeadphonesProducts(processedProducts);
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Men's Headphones ({sortedHeadphonesProducts.length})</h2>
