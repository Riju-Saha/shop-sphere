...
export default function Phones() {
  ...
  const [phonesProducts, setPhonesProducts] = useState<any[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setPhonesProducts(productsWithDate);
  ...
  const sortedPhonesProducts = useMemo(() => {
    let productsCopy = [...phonesProducts];
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: {currentUsername}'s Phones ({sortedPhonesProducts.length})</h2>

          {isLoadingProducts && <p style={{ color: 'gray', padding: '0 20px' }}>Loading products...</p>}

          {!isLoadingProducts && sortedPhonesProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No Phones products found for this seller.</p>
          )}

          <div style={styles.productGrid}>
            {sortedPhonesProducts.map((product, i) => (
              <div
                key={product.key || i}
                style={{
