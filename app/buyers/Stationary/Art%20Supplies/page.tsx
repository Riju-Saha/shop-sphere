...
export default function ArtSupplies() {
  ...
  const [ArtSuppliesProducts, setArtSuppliesProducts] = useState<Product[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setArtSuppliesProducts(processedProducts);
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Men's ArtSupplies ({sortedArtSuppliesProducts.length})</h2>
          ...
          <div style={styles.productGrid}>
            {sortedArtSuppliesProducts.map((product, i) => {
