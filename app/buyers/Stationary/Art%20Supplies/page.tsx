    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Stationary's ArtSupplies ({sortedArtSuppliesProducts.length})</h2>
          ...
          {!isLoadingProducts && sortedArtSuppliesProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No ArtSupplies products found for this buyer.</p>
          )}
