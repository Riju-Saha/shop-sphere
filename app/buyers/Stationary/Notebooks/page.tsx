...
export default function Notebooks() {
  ...
  const [NotebooksProducts, setNotebooksProducts] = useState<Product[]>([]);
  ...
  useEffect(() => {
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setNotebooksProducts(processedProducts);
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Men's Notebooks ({sortedNotebooksProducts.length})</h2>
