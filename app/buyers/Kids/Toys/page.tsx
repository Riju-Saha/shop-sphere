...
export default function Toys() {
  ...
  const [toysProducts, setToysProducts] = useState<any[]>([]);
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Kids's Toys ({sortedToysProducts.length})</h2>
          ...
          {!isLoadingProducts && sortedToysProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No Toys products found for this buyer.</p>
          )}
