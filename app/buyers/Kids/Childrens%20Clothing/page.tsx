...
export default function ChildrensClothing() {
  ...
  const [ChildrensClothingProducts, setChildrensClothingProducts] = useState<Product[]>([]);
  ...
  useEffect(() => {
    const category = 'Kids';
    const subCategory = 'Childrens Clothing';
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setChildrensClothingProducts(processedProducts);
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Men's ChildrensClothing ({sortedChildrensClothingProducts.length})</h2>
          ...
          {!isLoadingProducts && sortedChildrensClothingProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No ChildrensClothing products found for this seller.</p>
          )}

          <div style={styles.productGrid}>
            {sortedChildrensClothingProducts.map((product, i) => {
