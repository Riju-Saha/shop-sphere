    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={styles.sectionsContainerStyles}>
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Kids's SchoolSupplies ({sortedSchoolSuppliesProducts.length})</h2>
          ...
          {!isLoadingProducts && sortedSchoolSuppliesProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No SchoolSupplies products found for this buyer.</p>
          )}
