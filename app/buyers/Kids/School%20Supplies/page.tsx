...
export default function SchoolSupplies() {
  ...
  const [SchoolSuppliesProducts, setSchoolSuppliesProducts] = useState<Product[]>([]);
  ...
  useEffect(() => {
    const category = 'Kids';
    const subCategory = 'School Supplies';
    ...
    if (currentUsername && currentUsername !== 'Guest') {
      const fetchProducts = async () => {
        ...
        setSchoolSuppliesProducts(processedProducts);
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ color: 'white', padding: '0 20px', marginBottom: '10px' }}>Inventory: Men's SchoolSupplies ({sortedSchoolSuppliesProducts.length})</h2>
          ...
          {!isLoadingProducts && sortedSchoolSuppliesProducts.length === 0 && currentUsername !== 'Guest' && (
            <p style={{ color: 'gray', padding: '0 20px' }}>No SchoolSupplies products found for this seller.</p>
          )}
